(function() {
  ...
  storage.local.get(['hideWikia'], (result) => {
    if (result && result.hideWikia) {
      ...
      const wikiaLinks = document.querySelectorAll('[href*="kingkiller.fandom"], [href*="kingkiller.wikia"]');
      ...
      function getParent(element, maxDepth = 10) {
        if (element.parentElement) {
          if (element.className === 'g') {
            ...
            removedElement.innerHTML="Kingkiller Wikia search result removed by Kingkiller Wiki Redirector."
